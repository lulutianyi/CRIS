...
class Encoder(nn.Module):
    def __init__(
        self, in_channels, base_ch, num_res_blocks, latent_channels, ch_mult=(1,2,4)
    ):
        super().__init__()
        layers = []
...
class Decoder(nn.Module):
    def __init__(
        self, out_channels, base_ch, num_res_blocks, latent_channels, ch_mult=(4,2,1)
    ):
        super().__init__()
        layers = []
...
class VQModel(nn.Module):
    def __init__(
        ...
        base_ch=32, num_res_blocks=2, ch_mult=(1,2,4)
    ):
        super().__init__()
        self.encoder = Encoder(in_channels, base_ch, num_res_blocks, latent_channels, ch_mult=ch_mult)
